        ...
        <div className="flex flex-col gap-3">
          ...
          <Link href="/products">
            <motion.span
              whileHover={{ scale: 1.02 }}
              whileTap={{ scale: 0.97 }}
              className="block w-full border border-[#032616] text-[#032616] font-bold text-[11px] tracking-[0.14em] uppercase font-[var(--font-work-sans)] py-3 rounded-xl hover:bg-[#032616] hover:text-white transition-colors text-center">
              Browse Products
            </motion.span>
          </Link>
        </div>
